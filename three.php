...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
        <div class="container">
            ...
            <div>
                <h5 style="color:white">Step 3/6</h5>
            </div>
        </div>
    </nav>
    <!-- Masthead-->
        ...
        <div class="container d-flex align-items-center flex-column">
            ...
            <section class="page-section bg-primary text-white mb-0" id="about">
                <div class="container">
                    ...
                    <h1 class="text-uppercase mb-4">The Declaration of Independece</h4>
                        <h2 class="text-uppercase mb-4">Written by Thomas Jefferson</h4>
                            <para style="width: 100px;">The unanimous Declaration of the thirteen united States of
                                America
            ...
            <section>
                <div>
                    <h2>Please explain your favorite thing about <br> Thomas Jefferson's Declaration of Independence.
                    </h2>
                    <h5>If needed, use the above Declaration of Independence for reference.</h5>
                    <br>
                    <form action="four.html">
                        <div class="form-group">
                            <label for="exampleFormControlTextarea1">Limit Answer to 50 words.</label>
