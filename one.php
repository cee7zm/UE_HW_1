                ...
                <div class="container">
                    ...
                    <form action="two.html">
                        ...
                        <div class="form-group">
                            <div class="form-group">
                                <label style="color:#72BC9C" for="exampleInputPassword1">First Name</label>
                                <input type="name" class="form-control" id="exampleInputPassword1">
                            </div>
                            <div class="form-group">
                                <label style="color:#72BC9C" for="exampleInputPassword1">Zip Code</label>
                                <input type="zipcode" class="form-control" id="exampleInputPassword1">
                            </div>
                            <div class="form-group">
                                <label style="color:#72C29C" for="exampleInputPassword1">Birthday</label>
                                <input type="name" class="form-control" id="exampleInputPassword1">
                            </div>
                            <div class="form-group">
                                <label style="color:#72BC9C" for="exampleInputPassword1">State</label>
                                <input type="state" class="form-control" id="exampleInputPassword1">
                            </div>
                            <div class="form-group">
                                <label style="color:#72BC9C" for="exampleInputPassword1">Last Name</label>
                                <input type="name" class="form-control" id="exampleInputPassword1">
                            </div>
                            <div class="form-group">
                                <label style="color:#72BC9C" for="exampleInputPassword1">Street Name</label>
                                <input type="street" class="form-control" id="exampleInputPassword1">
                            </div>
                            <div class="form-group">
                                <label style="color:#72BC9C" for="exampleInputPassword1">Town</label>
                                <input type="town" class="form-control" id="exampleInputPassword1">
                            </div>
                            <label style="color:#72BC9C" for="exampleInputEmail1">Email address</label>
                            <input type="e" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                            <!-- <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small> -->
                        </div>
                        <div class="form-group">
                            <label style="color:#72BC9C" for="exampleInputPassword1">Create A Password</label>
