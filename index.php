        ...
        <div class="container d-flex align-items-center flex-column">
            ...
            <section class="page-section bg-primary text-white mb-0" id="about">
                <div class="container">
                    ...
                    <h2 class="page-section-heading text-center text-uppercase text-white">Welcome!</h2>
                    <!-- Icon Divider-->
                    ...
                    <div class="row">
                        <div class="col-lg-4 ml-auto">
                            <p class="lead">To apply to the University of Virignia, class of 2025, please fill out this
                                questionnaire.</p>
                        </div>
                        <div class="col-lg-4 mr-auto">
                            <p class="lead">Click the button to start!</p>
                        </div>
                    </div>
                    <!-- About Section Button-->
                    <div class="text-center mt-4">
                        <a class="btn btn-xl btn-outline-light" href="https://www.virginia.edu/">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-4 mb-5 mb-lg-0">
                            <a class="btn btn-xl btn-outline-light" href="https://admission.virginia.edu/">
                                <!-- <i class="fas fa-download mr-2"></i> -->
                                UVA Admissions >>
                            </a>
                        ...
                        <a class="btn btn-outline-light btn-social mx-1" href="#!"><i class="fab fa-fw fa-dribbble"></i></a> -->
                            <a class="btn btn-xl btn-outline-light" href="https://www.virginia.edu/apply">
                                <!-- <i class="fas fa-download mr-2"></i> -->
                                Apply >>
                            </a>
                        </div>
                        ...
                        <div class="col-lg-4">
                            ...
                            <a class="btn btn-xl btn-outline-light"
                                href="https://admission.virginia.edu/admission/statistics">
                                <!-- <i class="fas fa-download mr-2"></i> -->
                                UVA Stats >>
                            </a>
            ...
            <div class="copyright py-4 text-center text-white">
                <div class="container">
                    <a class="btn btn-xl btn-outline-light" href="one.html">
                        <!-- <i class="fas fa-download mr-2"></i> -->
                        Start
                    </a>
                </div>
